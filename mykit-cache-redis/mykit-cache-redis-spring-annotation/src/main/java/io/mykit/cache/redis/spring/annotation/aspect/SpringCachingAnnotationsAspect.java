package io.mykit.cache.redis.spring.annotation.aspect;

import io.mykit.cache.redis.spring.annotation.cache.CacheAnnotationSupport;
...
@Aspect
@Component
public class SpringCachingAnnotationsAspect {

    @Resource
    private CacheAnnotationSupport cacheAnnotationSupport;
    ...
    public Object registerInvocation(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        if (joinPoint.getSignature() instanceof MethodSignature) {
            ...
            cacheAnnotationSupport.registerInvocation(joinPoint.getTarget(), method, parameterTypes,
