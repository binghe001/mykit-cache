package io.mykit.cache.redis.spring.annotation.lock;
 ...
 */
@Slf4j
public class RedisAnnotationLock {
     ...
     */
    public RedisAnnotationLock(RedisTemplate redisTemplate, String lockKey) {
     ...
     */
    public RedisAnnotationLock(RedisTemplate redisTemplate, String lockKey, int expireTime) {
     ...
     */
    public RedisAnnotationLock(RedisTemplate redisTemplate, String lockKey, long timeOut) {
        this(redisTemplate, lockKey);
     ...
     * @param timeOut       请求锁的超时时间(单位：毫秒)
     */
    public RedisAnnotationLock(RedisTemplate redisTemplate, String lockKey, int expireTime, long timeOut) {
