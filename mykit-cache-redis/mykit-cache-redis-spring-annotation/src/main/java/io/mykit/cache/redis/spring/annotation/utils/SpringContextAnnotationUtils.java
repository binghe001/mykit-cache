 ...
 */
@Component
public class SpringContextAnnotationUtils implements ApplicationContextAware {
    ...
    public void setApplicationContext(ApplicationContext applicationContext) {
        SpringContextAnnotationUtils.applicationContext = applicationContext; // NOSONAR
    }
